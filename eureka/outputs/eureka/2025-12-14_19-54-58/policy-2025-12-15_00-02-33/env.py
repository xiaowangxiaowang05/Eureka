...
class ShadowHandQwen(VecTask):
    ...
    def compute_reward(self, actions):
        ...
        self.rew_buf[:], self.rew_dict = compute_reward(self.object_rot, self.goal_rot, self.object_angvel, self.actions, self.progress_buf, self.max_episode_length, self.shadow_hand_dof_pos, self.shadow_hand_dof_vel, self.prev_actions, self.shadow_hand_default_dof_pos)
