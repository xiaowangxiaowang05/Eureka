...
class ShadowHandQwen(VecTask):
    ...
    def compute_reward(self, actions):
        ...
        self.rew_buf[:], self.rew_dict = compute_reward(self.object_rot, self.goal_rot, self.object_angvel, self.fingertip_pos, self.object_pos, self.actions, self.success_tolerance, self.reach_goal_bonus, self.action_penalty_scale)
