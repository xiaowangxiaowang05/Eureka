...
def compute_reward(root_states: torch.Tensor, up_vec: torch.Tensor, actions: torch.Tensor, dt: float) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
    ...
    stability_temp = 2.0    # Higher temperature to make stability penalty more sensitive
    ...
    stability_penalty = -stability_temp * up_deviation * up_deviation  # Quadratic penalty for instability
