...
def compute_reward(root_states: torch.Tensor, up_vec: torch.Tensor, actions: torch.Tensor, dt: float) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
    ...
    # Use squared deviation for more sensitivity to small errors
    up_deviation = (up_vec[:, 2] - 1.0).pow(2)
    ...
    stability_temp = 2.0    # Higher temperature to make stability penalty more sensitive to small deviations
