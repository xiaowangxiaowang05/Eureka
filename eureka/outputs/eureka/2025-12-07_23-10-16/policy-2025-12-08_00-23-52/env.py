...
class ShadowHandQwen(VecTask):
    ...
    def compute_reward(self, actions):
        self.rew_buf[:], self.rew_dict = compute_reward(self.object_rot, self.goal_rot, self.object_linvel, self.object_angvel)
...
def compute_reward(object_rot: torch.Tensor, goal_rot: torch.Tensor, object_linvel: torch.Tensor, object_angvel: torch.Tensor) -> Tuple[torch.Tensor, Dict[str, torch.Tensor]]:
    ...
    # Penalize angular velocity to reduce wobbling and overshooting
